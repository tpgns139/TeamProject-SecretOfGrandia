...
image* imageManager::addImage(std::string key, std::string path, float sizeX, float sizeY)
{
	//--------------------------------------
	//디코더를 생성한다.
	//--------------------------------------
	...
	_image->setWidth(sizeX);
	_image->setHeight(sizeY);
...
image* imageManager::addFrameImage(std::string key, std::string path, int maxFrameX, int maxFrameY, float sizeX, float sizeY)
{
	...
	_image->setFrameHeight(sizeY);
	_image->setFrameWidth(sizeX);
